        ...
        <div className="relative w-full aspect-[4/5] max-h-[360px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-5 pb-6 flex items-end justify-between">
            ...
            <div className="flex items-center gap-3 pb-1">
              <a href="https://x.com/Riecocoamateras" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
              ...
              <a href="https://www.instagram.com/rie_iwanami_rie?igsh=Ynd4bTV0bG5reTBu&utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <span className="w-8 h-8 rounded-full flex items-center justify-center instagram-gradient">
                  <svg className="w-3.5 h-3.5 fill-white" viewBox="0 0 24 24">
              ...
              <a href="https://www.tiktok.com/@rie_iwanami_official" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                <span className="w-8 h-8 bg-black/60 rounded-full flex items-center justify-center">
                  <svg className="w-3.5 h-3.5 fill-white" viewBox="0 0 24 24">
